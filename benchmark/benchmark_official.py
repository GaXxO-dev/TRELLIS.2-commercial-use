#!/usr/bin/env python
"""
Inference Speed Benchmark for Official (nvdiffrast) Implementation.
...
# Setup paths for OFFICIAL implementation
SCRIPT_DIR = Path(__file__).parent
OFFICIAL_DIR = Path(__file__).parent.parent.parent / "TRELLIS.2"
FORK_DIR = Path(__file__).parent.parent
OUTPUT_DIR = FORK_DIR / "benchmark"

sys.path.insert(0, str(OFFICIAL_DIR))
os.chdir(str(OFFICIAL_DIR))
...
def run_benchmark():
    print("=" * 80)
    print("INFERENCE SPEED BENCHMARK: Official (nvdiffrast)")
    print("=" * 80)
    ...
    for iteration in range(NUM_ITERATIONS):
        ...
        # Step 9-12: GLB Export (timed internally)
        torch.cuda.synchronize()
...
def print_results(data):
    print()
    print("=" * 80)
    print("BENCHMARK RESULTS: Official (nvdiffrast)")
    print("=" * 80)
...
if __name__ == "__main__":
    ...
    output_path = OUTPUT_DIR / "benchmark_official.json"
